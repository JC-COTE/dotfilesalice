...
--- Waybar
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("/home/alice/.config/waybar/scripts/launch.sh"))
---Reload
hl.bind("SUPER + SHIFT + R", hl.dsp.exec_cmd("killall -SIGUSR2 waybar"), { description = "Reload Waybar" })   
--- ColorPicker
